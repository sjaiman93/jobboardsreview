            ...
            <div className="bg-white p-10 lg:p-14 rounded-[56px] card-shadow border border-slate-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2 group">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="name@company.com" className="w-full pl-14 pr-6 py-5 bg-slate-50 border-2 border-transparent rounded-[24px] outline-none transition-all focus:border-[#FF5630] focus:bg-white text-lg font-medium" />
                  </div>
                </div>
                ...
                <div className="space-y-2 group">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" id="company_name" value={companyName} onChange={(e) => setCompanyName(e.target.value)} required placeholder="Acme Recruitment" className="w-full pl-14 pr-6 py-5 bg-slate-50 border-2 border-transparent rounded-[24px] outline-none transition-all focus:border-[#FF5630] focus:bg-white text-lg font-medium" />
                  </div>
                </div>
              ...
              <div className="mt-10 pt-8 border-t border-slate-100 flex flex-col items-center gap-5">
                ...
                <div className="flex gap-4 w-full">
                  <button type="button" onClick={() => handleOAuth('google')} disabled={loading} className="flex-1 py-5 px-6 bg-white border border-slate-200 rounded-2xl flex items-center justify-center gap-2 font-bold hover:bg-slate-50 disabled:opacity-50 transition-colors">
                  ...
                  <button type="button" onClick={() => handleOAuth('linkedin_oidc')} disabled={loading} className="flex-1 py-5 px-6 bg-white border border-slate-200 rounded-2xl flex items-center justify-center gap-2 font-bold hover:bg-slate-50 disabled:opacity-50 transition-colors">
