...
export const metadata = {
  title: "Terms of Use | JobBoardsReview",
};

export default function TermsPage() {
  const content = getSiteContent()?.legal?.terms;

  return (
    <div className="max-w-4xl mx-auto px-6 py-24 lg:py-32">
      <h1 className="text-4xl lg:text-5xl font-black text-slate-900 mb-12">Terms of Use</h1>
      {content ? (
