              ...
              <div className="bg-white p-8 rounded-[32px] border border-slate-100 card-shadow">
                ...
                <div className="mt-8 pt-8 border-t border-slate-100 text-center">
                  <p className="text-xs text-slate-500 font-medium mb-3 leading-relaxed">
                    <strong className="text-slate-900 block mb-1">Own this job board?</strong>
                    Claim this profile to update details and respond to reviews.
                  </p>
                  <Link
                    href="/claim-listing"
